...
@section('content')
    ...
    <form action="{{ route('employer.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="requirement" name="requirement">{{old('requirement')}}</textarea>
            @error('requirement')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-3">
            ...
            <select class="form-select" id="work_type" name="work_type" value="{{old('work_type')}}">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="salary_range" name="salary_range" value="{{old('salary_range')}}">
            @error('salary_range')
            <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
